...
layout: default
title: About
seo_title: About Yu Xi Chau | Systems Journal
description: About Yu Xi Chau, who builds efficient AI systems that organizations can use, govern and trust.
permalink: /about/
---
<div class="sj-about">
  <div class="sj-about-intro">
    <div>
      <p class="sj-kicker">About the author</p>
      <h1>Yu Xi Chau</h1>
      <p class="sj-about-lede">I build efficient AI systems that organizations can use, govern and trust.</p>
    </div>
    <figure class="sj-about-portrait"><img src="{{ '/assets/images/bio-photo-20260912.png' | relative_url }}" alt="Yu Xi Chau" width="768" height="1024"><figcaption>Yu Xi Chau · Hong Kong</figcaption></figure>
  </div>
  <div class="sj-about-body">
    <p>I work across three connected areas: AI systems, AI governance, and AI application. The engineering question is central in all three: can a system deliver useful results efficiently, operate reliably, and remain understandable and governable in a real organisation?</p>
    <p>My current professional work is at FWD Insurance, where I build GenAI applications and set up AI governance. That includes LLMs, RAG, agentic workflows, production readiness, and the guardrails that help organisations use these systems responsibly. For the current details of my employment history, please see <a href="https://www.linkedin.com/in/yuxichau/">LinkedIn</a>.</p>
    <p class="sj-disclaimer">The views expressed on this site are my own and do not represent FWD Insurance or any other employer.</p>
    <h2>Background</h2>
