...
<div class="foot"><p><strong>Coverage.</strong> The OpenCode Go documentation currently lists 18 models. This page plots the 16 models for which the current Artificial Analysis v4.3 free feed exposes both an Intelligence Index and a cost-per-task value: Grok 4.5, GLM-5.2, GLM-5.1, GPT 5.6 Luna, Kimi K3, Kimi K2.7 Code, Kimi K2.6, MiMo-V2.5-Pro, Qwen3.8 Max, Qwen3.7 Max, Qwen3.7 Plus, DeepSeek V4 Pro, DeepSeek V4 Flash, MiniMax M3, MiniMax M2.7, and Hy3. MiMo-V2.5 and Qwen3.6 Plus are listed by OpenCode but are excluded because the current AA feed has no cost-per-task value for those exact models. DeepSeek V4 Flash is matched to AA's <em>DeepSeek V4 Flash 0731</em>; it is kept separate from AA's <em>DeepSeek V4.1 Flash</em>, which OpenCode does not list. Scores, prices, and the Go model list can change; regenerate from the vendored refresh script.</p></div>
<script>__CHART__
